      ...
      <v-container>
        ...
        >
          <v-flex mb-4>
            ...
            <p class="subheading font-weight-regular" style="left:100px">
              Utilizing Ethereum for Decentralized Blockfund
            </p>
          </v-flex>
        </v-layout>
        ...
        <v-layout row justify-center>
          <v-dialog v-model="startProjectDialog" max-width="600px" persistent>
            <v-btn slot="activator" color="blue"  >Start a Project</v-btn>
            <v-card>
              <v-card-title>
